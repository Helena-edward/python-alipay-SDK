...
class AlipayTradeRefundRequest(object):
    ...
    def app_cert_sn(self):
        return self._app_cert_sn

    @app_cert_sn.setter
    def app_cert_sn(self, value):
        self._app_cert_sn = value

    @property
    def alipay_root_cert_sn(self):
        return self._alipay_root_cert_sn

    @alipay_root_cert_sn.setter
    def alipay_root_cert_sn(self, value):
        self._alipay_root_cert_sn = value
    ...
    def get_params(self):
        ...
        if self.app_cert_sn:
            params['app_cert_sn'] = self.app_cert_sn
        if self.alipay_root_cert_sn:
            params['alipay_root_cert_sn'] = self.alipay_root_cert_sn
        return params
